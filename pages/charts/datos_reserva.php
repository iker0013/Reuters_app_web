  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Modificar reserva Hot Desk</h1>
          </div>
          <div class="col-sm-6">
    ...
    <?php
        $num_reserv = htmlspecialchars($_POST['num_reserv']);
        $num_desk = htmlspecialchars($_POST['num_desk']);
        $fecha_r = htmlspecialchars($_POST['fecha']);
        $hora_in = htmlspecialchars($_POST['hora_e']);
        $hora_out = htmlspecialchars($_POST['hora_s']);
        $array_fecha= explode("/", $fecha_r);
        $anio=substr($array_fecha[2],0,-1);
        $mes=$array_fecha[1];
        $dia=$array_fecha[0];
    ?>
    <script>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <form action="datos_reserva_m-action.php" method="post">
            <div class="card card-danger">
            
              <div class="card-header">
                <h3 class="card-title">Reserva tu Hot Desk</h3>
                <?php echo '<input type="hidden" class="form-control" name="n_reserva" value="'.$num_reserv.'" >' ;?>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="date" class="form-control" name="fecha" value="'.$anio.'-'.$mes.'-'.$dia.'" min="'.$fecha_hoy.'" max="'.$nueva_fecha.'">'; ?>
                  </div>              
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="number" class="form-control" name="n_desk" value="'.intval($num_desk).'" min="1" max="200" >' ;?>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<select class="form-control select2bs4" name="hora_i" style="width: 100%;">';
                        echo '<option value="'.$hora_in.'">'.$hora_in.'</option>';
                    ?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<select class="form-control select2bs4" name="hora_s" style="width: 100%;">';
                        echo '<option value="'.$hora_out.'">'.$hora_out.'</option>';
                    ?>
                      <option value="10:00:00">10:00</option>
                      <option value="11:00:00">11:00</option>
                      <option value="12:00:00">12:00</option>
                  ...
                  <?php 
                    echo '<input type="hidden" name="num_reserv" value="'.$num_reserv.'">';
                  ?>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
