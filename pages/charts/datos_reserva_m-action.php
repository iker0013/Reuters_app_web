    ...
    <?php
        ...
        if(intval($hi)>=intval($hf)){
            ...
            try{
                ...
                //$url = 'http://localhost:60863/api/modificar_reservacion/'.base64_encode($cadena);
                ...
                if($cod=="1"){
                    echo "<script>window.alert('Reserva modificada con exito');
			                location.href='./modificar_reserva.php';
                        </script> ";
		        }else{
