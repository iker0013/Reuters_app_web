...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $nombre_user = htmlspecialchars($_POST['nom_user']);
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              <form action="datos_user-action.php" method="post">
              <div class="card-header">
                <h3 class="card-title">Modifique los datos requeridos</h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="text" class="form-control" name="numero" value="'.$num_user.'" >';?>
                  </div>
                  <!-- /.input group -->
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="text" class="form-control" name="nombre" value="'.$nombre_user.'"  disabled>';?>
                  </div>
                  <!-- /.input group -->
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="text" class="form-control" name="correo" value="'.$correo.'" disabled>';?>
                  </div>
                  <!-- /.input group -->
				  <label>Area:</label>
                  ...
                  <div class="input-group">
                    ...
                    <?php echo '<input type="text" class="form-control" name="area" value="'.$area.'"  disabled>';?>
                  </div>
                  <!-- /.input group -->
